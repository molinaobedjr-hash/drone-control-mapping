...
class SessionReviewDialog(QDialog):
    ...
    def _display_report(
        ...
        count_labels = (
            ...
            ("TX MANUAL_CONTROL", "manual_control_tx"),
            ("RX RC channel reports", "rc_channel_rx"),
            ("RX servo-output reports", "servo_output_rx"),
            ("MAVLink rows missing raw hex", "missing_raw_hex"),
